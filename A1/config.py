...
SLOW_NODES_PERCENT = 30                         # Percent of slow nodes
LOW_CPU_NODES_PERCENT = 30                      # Percent of nodes with low cpu
...
MEAN_PER_NODE_TXN_GENERATION_TIME_IN_SECS = 60  # Mean txn-generation time per node
